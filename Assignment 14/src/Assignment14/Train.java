...
public class Train implements Runnable {
  ...
  /**
   * empties this train and augment the number of Passengers at the station with this nrOfPassenegers
   */
  ...
  public void run() {
    while (nrOfTrips < 10) {
      nrOfPassengers = Util.getRandomNumber(Simulation.MIN_TRAVELLERS, Simulation.MAX_TRAVELLERS);
      station.enterStation(nrOfPassengers);
      nrOfTrips++;
    }
    station.close();
